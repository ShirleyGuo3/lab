...
static struct cache_t *cache_il3 = NULL;/*Add for level 3 */
...
static struct cache_t *cache_dl3 = NULL;/*Add for level 3 */
      ...
      if (!mystricmp(cache_il2_opt, "none"))
      ...
      else if (!mystricmp(cache_il2_opt, "dl3"))
       {
      ...
      else /* */
	     {
          ...
          {
              if (!cache_dl3)
                  fatal("I-cache l3 cannot access D-cache l2 as it's undefined");
              cache_il3 = cache_dl3;
          }
          else
          {
